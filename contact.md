...
[Open an interest issue →](https://github.com/kousiknandy/rubberducking.club/issues/new?template=interest.yml)
...
<!-- BOOKING: when there's traction, the scheduling link goes here, above the issue link.
     Keep the issue link beneath it for people without a GitHub account. Later still,
     a roster with one scheduling link per duck. -->
